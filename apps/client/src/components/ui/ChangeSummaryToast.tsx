...
const ChangeSummaryToast = React.memo(function ChangeSummaryToast({
  changes,
  onDismiss,
  onReview,
}: ChangeSummaryToastProps) {
    ...
    <div style={containerStyle}>
      <div style={headerStyle}>
        ...
        <span style={titleStyle}>
          {changes.totalCount} file{changes.totalCount !== 1 ? 's' : ''} changed while you were away
        </span>
      </div>
