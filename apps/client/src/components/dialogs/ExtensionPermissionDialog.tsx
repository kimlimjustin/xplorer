...
const PermIcon = ({ perm }: { perm: string }) => {
  ...
  if (perm.startsWith('file:read')) return <svg {...props}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>;
  if (perm.startsWith('file:write')) return <svg {...props}><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>;
  if (perm.startsWith('file:delete')) return <svg {...props}><polyline points="3 6 5 6 21 6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>;
  if (perm.startsWith('file:execute') || perm.startsWith('system:')) return <svg {...props}><polyline points="4 17 10 11 4 5" /><line x1="12" y1="19" x2="20" y2="19" /></svg>;
  if (perm.startsWith('directory:')) return <svg {...props}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" /></svg>;
  if (perm === 'fetch' || perm === 'network') return <svg {...props}><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>;
  if (perm.includes('notification')) return <svg {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg>;
  if (perm.includes('panel') || perm.includes('modify')) return <svg {...props}><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><line x1="3" y1="9" x2="21" y2="9" /><line x1="9" y1="21" x2="9" y2="9" /></svg>;
  if (perm.includes('clipboard')) return <svg {...props}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" ry="1" /></svg>;
  if (perm.includes('storage')) return <svg {...props}><ellipse cx="12" cy="5" rx="9" ry="3" /><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" /><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" /></svg>;
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            >
              <svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="rgba(122, 162, 247, 0.9)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div style={{ padding: '14px 20px', overflowY: 'auto' as const, flex: 1 }}>
          ...
          {hasDangerous && (
            ...
            >
              ...
              <span style={{ fontSize: '12px', color: 'var(--xp-text-muted, #a9b1d6)', lineHeight: 1.4 }}>
                Requests{' '}
          ...
          {/* Permission list */}
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '4px', marginBottom: '14px' }}>
