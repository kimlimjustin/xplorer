            ...
            {!collapsedSections.has('suggestions') && (
              <div style={{ marginBottom: 16 }}>
                {analysis.suggestions.length === 0 ? (
                  <div
                    style={{ fontSize: 12, color: 'var(--xp-text-secondary)', padding: '8px 0' }}
                  >
                    {analysis.is_project
                  ...
                  <>
                    ...
                    {showPreview && preview && (
                      ...
                      >
                        ...
                        >
                          Preview: {preview.moves.length} file
                          {preview.moves.length !== 1 ? 's' : ''} to move
                        </div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                {analysis.insights.type_distribution.length > 0 && (
                  <div style={{ marginBottom: 12 }}>
                    <div
                      style={{ fontSize: 11, color: 'var(--xp-text-secondary)', marginBottom: 4 }}
                    >
                      Type distribution
                    </div>
                    <div
                    ...
                    <div
                      style={{ display: 'flex', flexWrap: 'wrap', gap: '2px 12px', marginTop: 4 }}
                    >
                      {analysis.insights.type_distribution.map((td) => (
                        <div
                          key={td.category}
                ...
                <div style={cardStyle}>
                  ...
                  <div style={{ marginBottom: 8 }}>
                    ...
                    {indexingStatus.aiQueueLength > 0 && (
                      <StatRow
                        label="Queue"
                        value={indexingStatus.aiQueueLength.toLocaleString()}
                      />
                    )}
                  ...
                  <div>
                    ...
                    {indexingStatus.tokenLastUpdated > 0 && (
                      <StatRow
                        label="Last Updated"
                        value={new Date(
                          indexingStatus.tokenLastUpdated * 1000,
                        ).toLocaleTimeString()}
                      />
                    )}
