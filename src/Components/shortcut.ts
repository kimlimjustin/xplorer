...
import { Trash, PermanentDelete } from '../Functions/Files/trash';
import {
	Preview,
 ...
 */
const Shortcut = (): void => {
	const { reload, minimize, maximize } = require('./windowManager'); //eslint-disable-line
	const { createNewTab, goBack, goForward } = require('./tab'); //eslint-disable-line
