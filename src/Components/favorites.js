...
const Favorites = (callback) => {
    let result = `<section class="home-section">
        ...
        <div class="favorite" data-tilt data-listenOpen data-isdir="true" data-path="${path.join(os.homedir(), 'Desktop')}">
        ...
        <div class="favorite" data-tilt data-listenOpen data-isdir="true" data-path="${path.join(os.homedir(), 'Documents')}">
        ...
        <div class="favorite" data-tilt data-listenOpen data-isdir="true" data-path="${path.join(os.homedir(), 'Downloads')}">
        ...
        <div class="favorite" data-tilt data-listenOpen data-isdir="true" data-path="${path.join(os.homedir(), 'Pictures')}">
        ...
        <div class="favorite" data-tilt data-listenOpen data-isdir="true" data-path="${path.join(os.homedir(), 'Music')}">
        ...
        <div class="favorite" data-tilt data-listenOpen data-isdir="true" data-path="${path.join(os.homedir(), 'Videos')}">
