...
const Favorites = (callback) => {
    let result = `<section class="home-section">
        ...
        <div class="favorite hover-effect" data-tilt data-listenOpen data-isdir="true" data-path="${escape(path.join(os.homedir(), 'Desktop'))}">
        ...
        <div class="favorite hover-effect" data-tilt data-listenOpen data-isdir="true" data-path="${escape(path.join(os.homedir(), 'Documents'))}">
        ...
        <div class="favorite hover-effect" data-tilt data-listenOpen data-isdir="true" data-path="${escape(path.join(os.homedir(), 'Downloads'))}">
        ...
        <div class="favorite hover-effect" data-tilt data-listenOpen data-isdir="true" data-path="${escape(path.join(os.homedir(), 'Pictures'))}">
        ...
        <div class="favorite hover-effect" data-tilt data-listenOpen data-isdir="true" data-path="${escape(path.join(os.homedir(), 'Music'))}">
        ...
        <div class="favorite hover-effect" data-tilt data-listenOpen data-isdir="true" data-path="${escape(path.join(os.homedir(), 'Videos'))}">
